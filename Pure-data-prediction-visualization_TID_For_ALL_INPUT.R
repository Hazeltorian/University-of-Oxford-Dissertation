...
All_TID_Heat_map_CM <- apply(confusion_mat_TIDFA, 2, function(x) x / sum(x))


pdf("TIDall_heatplot.pdf", width = 8, height = 5)
pheatmap(All_TID_Heat_map_CM, scale = "none",
...
scatter.smooth(team_ppg_sd$sensitivity ~ team_ppg_sd$mean_ppg,
xlab = "Mean Points Per Game",
ylab = "Sensitivity",lpars =
